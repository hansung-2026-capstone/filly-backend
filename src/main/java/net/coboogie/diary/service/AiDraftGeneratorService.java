...
public class AiDraftGeneratorService {
     ...
     */
    public AiDraftResult generate(String textContent, List<String> imageCaptions, LocalDate writtenAt) {
        String prompt = buildPrompt(textContent, imageCaptions, writtenAt);
     ...
     */
    private String buildPrompt(String textContent, List<String> imageCaptions, LocalDate writtenAt) {
